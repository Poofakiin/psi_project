...
/**
 * Hash SHA-256 a BigInt reducido módulo P-1 (para exponentes)
 */
...
/**
 * Convierte un hex string (digest) a BigInt reducido
 * (útil cuando el oblivious devuelve hex HMAC/sha256).
 */
export function hashHexToBigInt(hex: string): bigint {
  return BigInt("0x" + hex) % (P - BigInt(1));
}

/** Genera un secreto aleatorio en rango [2, P-2] */
